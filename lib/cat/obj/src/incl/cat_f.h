...
signed char *(__cdecl clcks_m(signed(args),void(*argp)));
signed char *(__cdecl clcks_xe(signed(args),void(*argp)));
signed char *(__cdecl clcks_r(signed(args),void(*argp)));
signed char *(__cdecl clcks(signed(args),void(*argp)));
signed char *(__cdecl clck_m_tz(signed(argt/*crown*/),signed(args),void(*argp)));
signed char *(__cdecl clck_m(signed(args),void(*argp)));
signed char *(__cdecl clck_xe(signed(args),void(*argp)));
signed char *(__cdecl clck_r(signed(args),void(*argp)));
...
signed char *(__cdecl cal_dm_abbrev_in_en_gb(signed(arg)));
signed char *(__cdecl cal_dm_abbrev_xe_in_en(signed(arg)));
signed char *(__cdecl cal_dm_abbrev_in_en(signed(arg)));
signed char *(__cdecl cal_dm_in_en_us(signed(arg)));
signed char *(__cdecl cal_dm_in_en_gb(signed(arg)));
...
signed char *(__cdecl cal_mo_in_en_gb(signed(arg)));
...
signed char *(__cdecl cv_md(signed(args),void(*argp)));
signed(__cdecl cal_md(signed(args),void(*argp)));
