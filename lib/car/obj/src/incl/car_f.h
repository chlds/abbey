...
signed(__cdecl cue_noalpha(signed char(*argp)));
signed(__cdecl cue_nonum(signed char(*argp)));
signed(__cdecl cue_nospa(signed char(*argp)));
...
signed(__cdecl cue_spa(signed char(*argp)));
