...
signed *(__cdecl catta_u_xe(signed(*args),signed(*argp)));
signed *(__cdecl catta_u(signed(*args),signed(*argp)));
signed *(__cdecl casse_u_xe_rr(signed(*args),signed(*argp)));
signed *(__cdecl casse_u_xe_r(signed(*args),signed(*argp)));
signed *(__cdecl casse_u_xe(signed(*args),signed(*argp)));
signed *(__cdecl casse_u_rr(signed(*args),signed(*argp)));
...
signed char *(__cdecl rmsym_xe(signed char(*argp)));
...
signed char *(__cdecl rmesp(signed char(*argp)));
...
signed char *(__cdecl rm_sym_xe(signed char(*argp)));
signed char *(__cdecl rm_sym_r(signed char(*argp)));
signed char *(__cdecl rm_sym(signed char(*argp)));
signed char *(__cdecl rm_esp_xe(signed char(*argp)));
signed char *(__cdecl rm_esp_r(signed char(*argp)));
...
signed char *(__cdecl cath_alphnum_xe(signed char(*argp)));
signed char *(__cdecl cath_alphnum(signed char(*argp)));
signed char *(__cdecl cath_alph_xe(signed char(*argp)));
...
signed char *(__cdecl catalphnum_xe(signed char(*argp)));
signed char *(__cdecl catalphnum(signed char(*argp)));
signed char *(__cdecl catalph_xe(signed char(*argp)));
signed char *(__cdecl catalph(signed char(*argp)));
signed char *(__cdecl catnum_xe(signed char(*argp)));
signed char *(__cdecl catnum(signed char(*argp)));
signed char *(__cdecl catnonesp_xe(signed char(*argp)));
signed char *(__cdecl catnonesp(signed char(*argp)));
signed char *(__cdecl catlxiv_xe(signed char(*argp)));
signed char *(__cdecl catlxiv(signed char(*argp)));
...
signed(__cdecl ordi_m(signed(args),signed(**argp)));
...
signed char **(__cdecl cathal_v_xe(signed char(*argp)));
...
signed char *(__cdecl cathal(signed(arg)));
...
signed **(__cdecl catta_m_xe(signed(**args),signed(**argp)));
signed **(__cdecl catta_m(signed(**args),signed(**argp)));
signed **(__cdecl casse_m_rr(signed(**args),signed(**argp)));
signed **(__cdecl casse_m_r(signed(**args),signed(**argp)));
signed **(__cdecl casse_m(signed(**args),signed(**argp)));
...
signed char **(__cdecl catta_v_xe(signed char(**args),signed char(**argp)));
signed char **(__cdecl catta_v(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v_xe_rr(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v_xe_r(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v_xe(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v_rr(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v_r(signed char(**args),signed char(**argp)));
signed char **(__cdecl casse_v(signed char(**args),signed char(**argp)));
