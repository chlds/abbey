...
signed char **(__cdecl cynth_b(signed(argt),signed char(**args),signed char(**argp)));
signed(__cdecl cyn_b(signed(argt),signed char(**args),signed char(**argp)));
signed(__cdecl cym_b(signed char(**args),signed char(**argp)));
signed char *(__cdecl cyb_b(signed char(**args),signed char(**argp)));
signed char *(__cdecl cara_b(signed char(**argp)));
