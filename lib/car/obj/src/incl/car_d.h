...
static signed CAR_H_EQ = ('=');
static signed char CAR_H_SPACE[] = (" ");
static signed char CAR_H_SYMBOLS[] = ("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~");
static signed char CAR_H_PADDING_IN_BASE_LXIV[] = ("=");
static signed char CAR_H_BASE_LXIV[] = ("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/");
